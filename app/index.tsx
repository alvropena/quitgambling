...
export default function Index() {
  ...
  const neutralBgColor = isDarkMode ? 'rgba(100, 100, 100, 0.1)' : 'rgba(240, 240, 240, 0.5)'; // Neutral background
      ...
      <View style={styles.contentContainer}>
          ...
          style={[
            ...
            { 
              ...
              backgroundColor: recoveryStarted 
                ...
                : (isDarkMode ? 'rgba(76, 217, 100, 0.2)' : 'rgba(76, 217, 100, 0.1)')
            }
          ]}
          onPress={handlePress}
          activeOpacity={0.8}
        ...
        <View style={[
          ...
          { 
            ...
            backgroundColor: recoveryStarted
              ? neutralBgColor
              : (isDarkMode ? 'rgba(76, 217, 100, 0.1)' : 'rgba(76, 217, 100, 0.05)')
          }
        ]}>
          <Text 
            style={[
          ...
          >
            {recoveryStarted ? 'Living gambling-free for' : 'Regain control of your life'}
          </Text>
          {recoveryStarted ? (
            <Text 
              style={[
